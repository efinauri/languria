...
pub fn iterative_param_binder_op(eval: &mut Evaluator, past_iterations: &usize, iterand: &Box<Value>, body: &Box<Expression>) -> Value {
...
pub fn bind_application_args_to_params_op(eval: &mut Evaluator, amount_of_passed_args: &usize, tok: &Token) -> Value {
...
pub fn assoc_grower_resolver_op(eval: &mut Evaluator, map: &ValueMap, n: &usize, is_lazy: &bool) -> Value {
...
pub fn assoc_grower_setupper_op(eval: &mut Evaluator, previous_val: &Value, map: &ValueMap, n: &usize, is_lazy: &bool) -> Value {
